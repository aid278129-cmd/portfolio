...
export const PLAYER_CHAIN = [
  ...
  },
  {
    ...
    card: {
      ...
      items: [
        { label: 'HTML5 / Semantic Markup',     desc: 'Shipped 20+ production pages with clean, accessible structure' },
        { label: 'CSS3 / Flexbox / Grid',       desc: 'Built complex responsive layouts across 15 client projects' },
        { label: 'JavaScript (ES2023+)',         desc: 'Interactive features & form validation in every project' },
        { label: 'Google Apps Script',          desc: 'Automated reporting workflows saving 10+ hrs/week' },
        { label: 'Responsive Design',           desc: 'Mobile-first approach tested on 50+ device profiles' },
        { label: 'Web Accessibility (WCAG)',     desc: 'Audited and fixed accessibility issues for a gov portal' },
      ],
    },
  },
  {
    ...
    card: {
      ...
      items: [
        { label: 'React / Next.js',             desc: 'Component libraries & dashboards in 5 production apps' },
        { label: 'Node.js / Express / REST',    desc: 'Built REST APIs powering e-commerce checkout flows' },
        { label: 'TypeScript',                  desc: 'Gradual adoption across existing JavaScript codebases' },
        { label: 'Python / FastAPI',            desc: 'Backend services for data dashboards & scraping pipelines' },
        { label: 'PostgreSQL / Redis / Mongo',  desc: 'Designed schemas & optimized queries for 100k+ row tables' },
        { label: 'GraphQL / tRPC',              desc: 'Prototype typed APIs for internal tooling projects' },
      ],
    },
  },
  {
    ...
    card: {
      ...
      items: [
        { label: 'Glassmorphism / Neumorphism', desc: 'Applied modern UI trends across SaaS landing pages' },
        { label: 'Framer Motion / GSAP',        desc: 'Scroll-driven animations & micro-interactions on this site' },
        { label: 'Three.js / WebGL / R3F',      desc: 'Built this scroll-driven stadium portfolio' },
        { label: 'Figma → Code Workflows',      desc: 'Pixel-perfect translations from Figma to React components' },
        { label: 'Animated Components / Lottie',desc: 'Embedded Lottie after-effects animations in marketing pages' },
        { label: 'Design Systems / Tokens',     desc: 'Created reusable token-based theme systems for teams' },
      ],
    },
  },
]
